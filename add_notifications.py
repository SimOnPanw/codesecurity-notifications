    ...
    try:
        new_section = {
            ...
            "rule": {
                ...
                "excludePolicies": [],
                "securityCategories": [],
                "pcNotificationIntegrations": [{"integrationId": integration_id}],
            },
...
if __name__ == "__main__":
    ...
    parser.add_argument("-r", "--repositories", nargs="+", required=True, help="List of repositories")
    parser.add_argument(
        "-s", "--severity", required=True, choices=["CRITICAL", "HIGH", "MEDIUM", "LOW", "INFO"], help="Severity level"
    )
    parser.add_argument("-i", "--integration-name", required=True, help="Integration name")
